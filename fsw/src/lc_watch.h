...
**  \retcode #LC_WDTVAL_ERR_DATATYPE \retdesc \copydoc LC_WDTVAL_ERR_DATATYPE
*\endcode
**  \retcode #LC_WDTVAL_ERR_OPER     \retdesc \copydoc LC_WDTVAL_ERR_OPER
*\endcode
**  \retcode #LC_WDTVAL_ERR_MID      \retdesc \copydoc LC_WDTVAL_ERR_MID
*\endcode
**  \retcode #LC_WDTVAL_ERR_FPNAN    \retdesc \copydoc LC_WDTVAL_ERR_FPNAN
*\endcode
**  \retcode #LC_WDTVAL_ERR_FPINF    \retdesc \copydoc LC_WDTVAL_ERR_FPINF
*\endcode
**  \endreturns
**
**  \sa #LC_ValidateADT
...
**
**  \returns
**  \retstmt Returns pointer to the watchpoint linked list entry just added
*\endcode
**  \endreturns
**
*************************************************************************/
