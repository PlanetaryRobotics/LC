...
#define LC_STATE_FROM_CDS                        \
    4 /**< \brief Only used for reset processing \
...
#define LC_ACTION_NOT_USED                               \
    0xFF /**< \brief Used to indicate unused actionpoint \
                     table entries. Not valid as a       \
                     command argument                    */
#define LC_APSTATE_ACTIVE   1
#define LC_APSTATE_PASSIVE  2
#define LC_APSTATE_DISABLED 3
#define LC_APSTATE_PERMOFF                         \
    4 /**< \brief To set this state requires using \
...
/** \{ */
#define LC_HKAR_STATE_NOT_USED                       \
    0x00 /**< \brief Two bit value used for NOT USED \
                     as well as PERMOFF                  */
#define LC_HKAR_STATE_ACTIVE \
    0x01 /**< \brief Two bit value used for ACTIVE       */
#define LC_HKAR_STATE_PASSIVE \
    0x02 /**< \brief Two bit value used for PASSIVE      */
#define LC_HKAR_STATE_DISABLED \
    0x03 /**< \brief Two bit value used for DISABLED     */
/** \} */
...
#define LC_HKWR_NUM_BYTES                     \
    (((LC_MAX_WATCHPOINTS + 15) / 16) *       \
     4) /**< \brief 2 bits per WP and keeping \
                    array on longword boundary   */
#define LC_HKAR_NUM_BYTES                     \
    (((LC_MAX_ACTIONPOINTS + 7) / 8) *        \
     4) /**< \brief 4 bits per AP and keeping \
                    array on longword boundary   */
/** \} */
