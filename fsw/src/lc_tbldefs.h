...
#define LC_DATA_WORD_BE              \
    3 /**< \brief 16 bit signed word \
                  big endian byte order       */

#define LC_DATA_WORD_LE              \
    4 /**< \brief 16 bit signed word \
                  little endian byte order    */

#define LC_DATA_UWORD_BE               \
    5 /**< \brief 16 bit unsigned word \
                  big endian byte order       */

#define LC_DATA_UWORD_LE               \
    6 /**< \brief 16 bit unsigned word \
                  little endian byte order    */

#define LC_DATA_DWORD_BE                    \
    7 /**< \brief 32 bit signed double word \
                  big endian byte order       */

#define LC_DATA_DWORD_LE                    \
    8 /**< \brief 32 bit signed double word \
                  little endian byte order    */

#define LC_DATA_UDWORD_BE                     \
    9 /**< \brief 32 bit unsigned double word \
                  big endian byte order       */

#define LC_DATA_UDWORD_LE                      \
    10 /**< \brief 32 bit unsigned double word \
                   little endian byte order    */

#define LC_DATA_FLOAT_BE                           \
    11 /**< \brief 32 bit single precision         \
                   IEEE-754 floating point number, \
                   big endian byte order */

#define LC_DATA_FLOAT_LE                           \
    12 /**< \brief 32 bit single precision         \
                   IEEE-754 floating point number, \
                   little endian byte order */
/** \} */
...
#define LC_WATCH_FALSE             \
    0 /* This needs to be zero for \
              correct RPN evalution  */
#define LC_WATCH_TRUE             \
    1 /* This needs to be one for \
...
#define LC_WDTVAL_ERR_DATATYPE \
    1                         /**< \brief Invalid DataType                  */
...
#define LC_ADTVAL_ERR_DEFSTATE \
    1                           /**< \brief Invalid DefaultState              */
