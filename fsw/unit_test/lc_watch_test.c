...
void LC_CreateHashTable_Test_UnsubscribeError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_UNSUB_WP_ERR_EID, CFE_EVS_ERROR,
...
void LC_CreateHashTable_Test_NominalAllSameMID(void) {
    ...
    for (WatchPtTblIndex = 0; WatchPtTblIndex < LC_MAX_WATCHPOINTS;
         WatchPtTblIndex++) {
    ...
    /* Verify results */
    /* Nothing to verify for LC_OperData.WatchPtLinks, because it depends on
     * LC_AddWatchpoint, which we're not testing here */
...
void LC_AddWatchpoint_Test_HashTableAndWatchPtListNullPointersNominal(void) {
    ...
    UtAssert_True(
        ...
        "LC_OperData.HashTable[HashTableIndex] == "
        "&LC_OperData.MessageLinks[0]");
    UtAssert_True(LC_OperData.MessageLinks[0].MessageID == 1,
                  "LC_OperData.MessageLinks[0].MessageID == 1");
    UtAssert_True(
        LC_OperData.MessageLinks[0].WatchPtList == &LC_OperData.WatchPtLinks[0],
        "LC_OperData.MessageLinks[0].WatchPtList == "
        "&LC_OperData.WatchPtLinks[0]");
    UtAssert_True(Result == &LC_OperData.WatchPtLinks[0],
                  "Result == &LC_OperData.WatchPtLinks[0]");
...
void LC_AddWatchpoint_Test_HashTableAndWatchPtListNotNullPointerTwoMsgLinksMIDFound(
    void) {
    LC_WatchPtList_t *Result;
    ...
    LC_OperData.MessageLinks[0].WatchPtList->Next =
        &LC_OperData.WatchPtLinks[1];
    LC_OperData.HashTable[HashTableIndex]->Next = &LC_OperData.MessageLinks[1];

    LC_OperData.MessageLinks[1].WatchPtList->Next =
        &LC_OperData.WatchPtLinks[2];
    ...
    UtAssert_True(Result == &LC_OperData.WatchPtLinks[0],
                  "Result == &LC_OperData.WatchPtLinks[0]");
    /* Not verifying line "WatchPtLink->Next =
     * &LC_OperData.WatchPtLinks[LC_OperData.WatchpointCount++]" */
...
void LC_CheckMsgForWPs_Test_Nominal(void) {
    ...
    LC_OperData.HashTable[LC_GetHashTableIndex(1)]->Next =
        LC_OperData.HashTable[LC_GetHashTableIndex(2)];
    LC_OperData.HashTable[LC_GetHashTableIndex(1)]->Next->MessageID = 1;

    LC_OperData.HashTable[LC_GetHashTableIndex(1)]
        ->Next->WatchPtList->WatchIndex             = WatchIndex;
    LC_OperData.WDTPtr[WatchIndex].DataType         = LC_DATA_BYTE;
    LC_OperData.WDTPtr[WatchIndex].WatchpointOffset = -1;

    LC_OperData.HashTable[LC_GetHashTableIndex(1)]->Next->Next =
        LC_OperData.HashTable[LC_GetHashTableIndex(3)];
    LC_OperData.HashTable[LC_GetHashTableIndex(1)]
        ->Next->Next->WatchPtList->WatchIndex = 99;
    ...
    /* Verify results */
    UtAssert_True(LC_AppData.MonitoredMsgCount == 1,
                  "LC_AppData.MonitoredMsgCount == 1");
...
void LC_CheckMsgForWPs_Test_UnreferencedMessageID(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_MID_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ProcessWP_Test_CustomFunctionWatchFalse(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_CFCALL_ERR_EID, CFE_EVS_ERROR,
...
void LC_OperatorCompare_Test_DataTypeError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_WP_DATATYPE_ERR_EID, CFE_EVS_ERROR,
...
void LC_SignedCompare_Test_InvalidOperatorID(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_WP_OPERID_ERR_EID, CFE_EVS_ERROR,
...
void LC_FloatCompare_Test_NaN(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_WP_NAN_ERR_EID, CFE_EVS_ERROR,
...
void LC_WPOffsetValid_Test_OffsetError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WP_OFFSET_ERR_EID, CFE_EVS_ERROR,
                                       "WP offset error: MID = 1, WP = 0, "
                                       "Offset = 8, DataSize = 1, MsgLen = 8"),
                  "WP offset error: MID = 1, WP = 0, Offset = 8, DataSize = 1, "
                  "MsgLen = 8");
...
void LC_ValidateWDT_Test_UnusedTableEntry(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_WDTVAL_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ValidateWDT_Test_InvalidDataType(void) {
    ...
    /* Verify results */
    UtAssert_True(Result == LC_WDTVAL_ERR_DATATYPE,
                  "Result == LC_WDTVAL_ERR_DATATYPE");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_WDTVAL_ERR_EID, CFE_EVS_ERROR,
...
void LC_ValidateWDT_Test_BadMessageID(void) {
    ...
    for (TableIndex = 0; TableIndex < LC_MAX_WATCHPOINTS; TableIndex++) {
        ...
        LC_OperData.WDTPtr[TableIndex].MessageID =
            CFE_SB_HIGHEST_VALID_MSGID + 1;
        LC_OperData.WDTPtr[TableIndex].ComparisonValue.Unsigned32 = 3;
    }
...
void LC_ValidateWDT_Test_NaN(void) {
    ...
    /* Verify results */
    UtAssert_True(Result == LC_WDTVAL_ERR_FPNAN,
                  "Result == LC_WDTVAL_ERR_FPNAN");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_WDTVAL_FPERR_EID, CFE_EVS_ERROR,
                             "WDT verify float err: WP = 0, Err = 4, "
                             "ComparisonValue = 0x7F8FFFFF"),
...
void LC_ValidateWDT_Test_Inf(void) {
    ...
    /* Verify results */
    UtAssert_True(Result == LC_WDTVAL_ERR_FPINF,
                  "Result == LC_WDTVAL_ERR_FPINF");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_WDTVAL_FPERR_EID, CFE_EVS_ERROR,
                             "WDT verify float err: WP = 0, Err = 5, "
                             "ComparisonValue = 0x7F800000"),
...
void LC_Watch_Test_AddTestCases(void) {
    UtTest_Add(LC_CreateHashTable_Test_UnsubscribeError, LC_Test_Setup,
               LC_Test_TearDown, "LC_CreateHashTable_Test_UnsubscribeError");
    UtTest_Add(LC_CreateHashTable_Test_NominalAllSameMID, LC_Test_Setup,
               LC_Test_TearDown, "LC_CreateHashTable_Test_NominalAllSameMID");
    ...
    UtTest_Add(
        LC_AddWatchpoint_Test_HashTableAndWatchPtListNotNullPointerTwoMsgLinksMIDFound,
        LC_Test_Setup, LC_Test_TearDown,
        "LC_AddWatchpoint_Test_"
        "HashTableAndWatchPtListNotNullPointerTwoMsgLinksMIDFound");
    ...
    UtTest_Add(LC_CheckMsgForWPs_Test_Nominal, LC_Test_Setup, LC_Test_TearDown,
               "LC_CheckMsgForWPs_Test_Nominal");
    UtTest_Add(LC_CheckMsgForWPs_Test_UnreferencedMessageID, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_CheckMsgForWPs_Test_UnreferencedMessageID");

    UtTest_Add(LC_ProcessWP_Test_CustomFunctionWatchFalse, LC_Test_Setup,
               LC_Test_TearDown, "LC_ProcessWP_Test_CustomFunctionWatchFalse");
    UtTest_Add(LC_ProcessWP_Test_OperatorCompareError, LC_Test_Setup,
               LC_Test_TearDown, "LC_ProcessWP_Test_OperatorCompareError");
    ...
    /* Note: Only testing little-ending (LE) cases.  Not testing big-endian (BE)
     * cases. */
    UtTest_Add(LC_OperatorCompare_Test_DataByte, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataByte");
    UtTest_Add(LC_OperatorCompare_Test_DataWordLE, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataWordLE");
    UtTest_Add(LC_OperatorCompare_Test_DataDWordLE, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataDWordLE");
    UtTest_Add(LC_OperatorCompare_Test_DataUByte, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataUByte");
    UtTest_Add(LC_OperatorCompare_Test_DataUWordLE, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataUWordLE");
    UtTest_Add(LC_OperatorCompare_Test_DataUDWordLE, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataUDWordLE");
    UtTest_Add(LC_OperatorCompare_Test_DataFloatLE, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataFloatLE");
    UtTest_Add(LC_OperatorCompare_Test_DataTypeError, LC_Test_Setup,
               LC_Test_TearDown, "LC_OperatorCompare_Test_DataTypeError");

    UtTest_Add(LC_SignedCompare_Test_LE, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_LE");
    UtTest_Add(LC_SignedCompare_Test_LT, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_LT");
    UtTest_Add(LC_SignedCompare_Test_EQ, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_EQ");
    UtTest_Add(LC_SignedCompare_Test_NE, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_NE");
    UtTest_Add(LC_SignedCompare_Test_GT, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_GT");
    UtTest_Add(LC_SignedCompare_Test_GE, LC_Test_Setup, LC_Test_TearDown,
               "LC_SignedCompare_Test_GE");
    UtTest_Add(LC_SignedCompare_Test_InvalidOperatorID, LC_Test_Setup,
               LC_Test_TearDown, "LC_SignedCompare_Test_InvalidOperatorID");

    UtTest_Add(LC_UnsignedCompare_Test_LE, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_LE");
    UtTest_Add(LC_UnsignedCompare_Test_LT, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_LT");
    UtTest_Add(LC_UnsignedCompare_Test_EQ, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_EQ");
    UtTest_Add(LC_UnsignedCompare_Test_NE, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_NE");
    UtTest_Add(LC_UnsignedCompare_Test_GT, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_GT");
    UtTest_Add(LC_UnsignedCompare_Test_GE, LC_Test_Setup, LC_Test_TearDown,
               "LC_UnsignedCompare_Test_GE");
    UtTest_Add(LC_UnsignedCompare_Test_InvalidOperatorID, LC_Test_Setup,
               LC_Test_TearDown, "LC_UnsignedCompare_Test_InvalidOperatorID");
    ...
    UtTest_Add(LC_FloatCompare_Test_InvalidOperatorID, LC_Test_Setup,
               LC_Test_TearDown, "LC_FloatCompare_Test_InvalidOperatorID");
    UtTest_Add(LC_FloatCompare_Test_NaN, LC_Test_Setup, LC_Test_TearDown,
               "LC_FloatCompare_Test_NaN");

    UtTest_Add(LC_WPOffsetValid_Test_DataUByte, LC_Test_Setup, LC_Test_TearDown,
               "LC_WPOffsetValid_Test_DataUByte");
    UtTest_Add(LC_WPOffsetValid_Test_UWordLE, LC_Test_Setup, LC_Test_TearDown,
               "LC_WPOffsetValid_Test_UWordLE");
    UtTest_Add(LC_WPOffsetValid_Test_UDWordLE, LC_Test_Setup, LC_Test_TearDown,
               "LC_WPOffsetValid_Test_UDWordLE");
    UtTest_Add(LC_WPOffsetValid_Test_FloatLE, LC_Test_Setup, LC_Test_TearDown,
               "LC_WPOffsetValid_Test_FloatLE");
    UtTest_Add(LC_WPOffsetValid_Test_DataTypeError, LC_Test_Setup,
               LC_Test_TearDown, "LC_WPOffsetValid_Test_DataTypeError");
    UtTest_Add(LC_WPOffsetValid_Test_OffsetError, LC_Test_Setup,
               LC_Test_TearDown, "LC_WPOffsetValid_Test_OffsetError");

    UtTest_Add(LC_GetSizedWPData_Test_DataByte, LC_Test_Setup, LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataByte");
    UtTest_Add(LC_GetSizedWPData_Test_DataUByte, LC_Test_Setup,
               LC_Test_TearDown, "LC_GetSizedWPData_Test_DataUByte");
    UtTest_Add(LC_GetSizedWPData_Test_DataWordBELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataWordBELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataWordLELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataWordLELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataUWordBELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataUWordBELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataUWordLELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataUWordLELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataFloatBELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataFloatBELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataFloatLELittleEndian, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_GetSizedWPData_Test_DataFloatLELittleEndian");
    UtTest_Add(LC_GetSizedWPData_Test_DataTypeError, LC_Test_Setup,
               LC_Test_TearDown, "LC_GetSizedWPData_Test_DataTypeError");

    UtTest_Add(LC_ValidateWDT_Test_UnusedTableEntry, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_UnusedTableEntry");
    UtTest_Add(LC_ValidateWDT_Test_InvalidDataType, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_InvalidDataType");
    UtTest_Add(LC_ValidateWDT_Test_InvalidOperator, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_InvalidOperator");
    UtTest_Add(LC_ValidateWDT_Test_BadMessageID, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_BadMessageID");
    UtTest_Add(LC_ValidateWDT_Test_NaN, LC_Test_Setup, LC_Test_TearDown,
               "LC_ValidateWDT_Test_NaN");
    UtTest_Add(LC_ValidateWDT_Test_Inf, LC_Test_Setup, LC_Test_TearDown,
               "LC_ValidateWDT_Test_Inf");
    UtTest_Add(LC_ValidateWDT_Test_FloatingPointPassed, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_FloatingPointPassed");
    UtTest_Add(LC_ValidateWDT_Test_NonFloatingPointPassed, LC_Test_Setup,
               LC_Test_TearDown, "LC_ValidateWDT_Test_NonFloatingPointPassed");

    UtTest_Add(LC_Uint32IsNAN_Test_True, LC_Test_Setup, LC_Test_TearDown,
               "LC_Uint32IsNAN_Test_True");
    UtTest_Add(LC_Uint32IsNAN_Test_False, LC_Test_Setup, LC_Test_TearDown,
               "LC_Uint32IsNAN_Test_False");

    UtTest_Add(LC_Uint32IsInfinite_Test_True, LC_Test_Setup, LC_Test_TearDown,
               "LC_Uint32IsInfinite_Test_True");
    UtTest_Add(LC_Uint32IsInfinite_Test_False, LC_Test_Setup, LC_Test_TearDown,
               "LC_Uint32IsInfinite_Test_False");
