...
void LC_Custom_Test_AddTestCases(void) {
    UtTest_Add(LC_ExecuteRTS_Test, LC_Test_Setup, LC_Test_TearDown,
               "LC_ExecuteRTS_Test");
    UtTest_Add(LC_CustomFunction_Test_WatchIndex0, LC_Test_Setup,
               LC_Test_TearDown, "LC_CustomFunction_Test_WatchIndex0");
    UtTest_Add(LC_CustomFunction_Test_WatchIndex1, LC_Test_Setup,
               LC_Test_TearDown, "LC_CustomFunction_Test_WatchIndex1");
