...
int32 LC_CMDS_TEST_CFE_TBL_GetAddressHook(void **TblPtr,
...
void LC_AppPipe_Test_Noop(void) {
    ...
    CFE_SB_InitMsg((CFE_SB_MsgPtr_t)(&CmdPacket), LC_CMD_MID,
                   sizeof(LC_NoArgsCmd_t), TRUE);
    ...
    /* Note: this event message is generated in a subfunction, but is tested
     * anyway to verify that the correct code path has been reached */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_NOOP_INF_EID, CFE_EVS_INFORMATION,
...
void LC_AppPipe_Test_Reset(void) {
    ...
    /* Note: this event message is generated in a subfunction, but is tested
     * anyway to verify that the correct code path has been reached */
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_RESET_DBG_EID, CFE_EVS_DEBUG,
...
void LC_AppPipe_Test_InvalidCommandCode(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_CC_ERR_EID, CFE_EVS_ERROR,
...
void LC_SampleAPReq_Test_AllowSampleAllWatchStale(void) {
    ...
    CFE_SB_InitMsg((CFE_SB_MsgPtr_t)(&CmdPacket), LC_SAMPLE_AP_MID,
...
void LC_SampleAPReq_Test_StartLessOrEqualToEndAndEndWithinArrayWatchStale(
    void) {
    LC_SampleAP_t CmdPacket;
...
void LC_SampleAPReq_Test_ArrayIndexOutOfRange(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_APSAMPLE_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_HousekeepingReq_Test_WatchStale(void) {
    ...
    CFE_SB_InitMsg((CFE_SB_MsgPtr_t)(&CmdPacket), LC_SEND_HK_MID,
                   sizeof(LC_NoArgsCmd_t), TRUE);
...
void LC_SetLCStateCmd_Test_Active(void) {
    ...
    /* Verify results */
    UtAssert_True(LC_AppData.CurrentLCState == LC_STATE_ACTIVE,
                  "LC_AppData.CurrentLCState == LC_STATE_ACTIVE");
    UtAssert_True(LC_AppData.CmdCount == 1, "LC_AppData.CmdCount == 1");

    UtAssert_True(Ut_CFE_EVS_EventSent(LC_LCSTATE_INF_EID, CFE_EVS_INFORMATION,
...
void LC_SetLCStateCmd_Test_Passive(void) {
    ...
    /* Verify results */
    UtAssert_True(LC_AppData.CurrentLCState == LC_STATE_PASSIVE,
...
void LC_SetLCStateCmd_Test_Disabled(void) {
    ...
    /* Verify results */
    UtAssert_True(LC_AppData.CurrentLCState == LC_STATE_DISABLED,
...
void LC_SetLCStateCmd_Test_Default(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_LCSTATE_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPStateCmd_Test_Default(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_APSTATE_NEW_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPStateCmd_Test_SetAllActionPointsActive(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APSTATE_INF_EID, CFE_EVS_INFORMATION,
...
void LC_SetAPStateCmd_Test_UpdateSingleActionPointActive(void) {
    ...
    /* Verify results */
    UtAssert_True(LC_OperData.ARTPtr[CmdPacket.APNumber].CurrentState ==
                      LC_APSTATE_ACTIVE,
                  "LC_OperData.ARTPtr[CmdPacket.APNumber].CurrentState == "
                  "LC_APSTATE_ACTIVE");
...
void LC_SetAPStateCmd_Test_InvalidCurrentAPStateActive(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_APSTATE_CURR_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPStateCmd_Test_InvalidAPNumberActive(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APSTATE_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPPermOffCmd_Test_InvalidAPNumberMaxActionpoints(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APOFF_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPPermOffCmd_Test_InvalidAPNumberAllActionpoints(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(
                      LC_APOFF_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_SetAPPermOffCmd_Test_APNotDisabled(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APOFF_CURR_ERR_EID, CFE_EVS_ERROR,
                             "Set AP perm off error, AP NOT Disabled: AP = 1, "
                             "Current state = 99"),
...
void LC_SetAPPermOffCmd_Test_Nominal(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APOFF_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ResetAPStatsCmd_Test_AllActionPoints(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSTATS_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ResetAPStatsCmd_Test_InvalidAPNumber(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_APSTATS_APNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_ResetResultsAP_Test(void) {
    ...
    UtAssert_True(LC_OperData.ARTPtr[TableIndex].CurrentState == 1,
...
void LC_ResetWPStatsCmd_Test_AllWatchPoints(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_WPSTATS_INF_EID, CFE_EVS_INFORMATION,
...
void LC_ResetWPStatsCmd_Test_InvalidWPNumber(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(LC_WPSTATS_WPNUM_ERR_EID, CFE_EVS_ERROR,
...
void LC_ResetResultsWP_Test(void) {
    ...
    for (TableIndex = StartIndex; TableIndex <= EndIndex; TableIndex++) {
        ...
        LC_OperData.WRTPtr[TableIndex].LastFalseToTrue.Timestamp.Subseconds =
            99;

        LC_OperData.WRTPtr[TableIndex].LastTrueToFalse.Value             = 99;
        LC_OperData.WRTPtr[TableIndex].LastTrueToFalse.Timestamp.Seconds = 99;
        LC_OperData.WRTPtr[TableIndex].LastTrueToFalse.Timestamp.Subseconds =
            99;
    }
    ...
    UtAssert_True(
        ...
        "LC_OperData.WRTPtr[TableIndex].LastFalseToTrue.Timestamp.Seconds == "
        "0");
    UtAssert_True(
        LC_OperData.WRTPtr[TableIndex].LastFalseToTrue.Timestamp.Subseconds ==
            0,
    ...
    UtAssert_True(
        ...
        "LC_OperData.WRTPtr[TableIndex].LastTrueToFalse.Timestamp.Seconds == "
        "0");
    UtAssert_True(
        LC_OperData.WRTPtr[TableIndex].LastTrueToFalse.Timestamp.Subseconds ==
            0,
...
void LC_VerifyMsgLength_Test_HKRequestLengthError(void) {
    ...
    /* Execute the function being tested */
    Result =
        LC_VerifyMsgLength((CFE_SB_MsgPtr_t)(&CmdPacket), sizeof(CmdPacket));

    /* Verify results */
    UtAssert_True(Result == FALSE, "Result == FALSE");

    UtAssert_True(Ut_CFE_EVS_EventSent(LC_HKREQ_LEN_ERR_EID, CFE_EVS_ERROR,
                                       "Invalid HK request msg length: ID = "
                                       "0x18A5, CC = 0, Len = 1, Expected = 8"),
                  "Invalid HK request msg length: ID = 0x18A5, CC = 0, Len = "
                  "1, Expected = 8");
...
void LC_VerifyMsgLength_Test_APSampleLengthError(void) {
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(LC_APSAMPLE_LEN_ERR_EID, CFE_EVS_ERROR,
                                       "Invalid AP sample msg length: ID = "
                                       "0x18A6, CC = 0, Len = 1, Expected = 8"),
                  "Invalid AP sample msg length: ID = 0x18A6, CC = 0, Len = 1, "
                  "Expected = 8");
...
void LC_VerifyMsgLength_Test_GenericLengthError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_LEN_ERR_EID, CFE_EVS_ERROR,
            "Invalid msg length: ID = 0x0001, CC = 0, Len = 1, Expected = 8"),
        "Invalid AP sample msg length: ID = 0x0001, CC = 0, Len = 1, Expected "
        "= 8");
...
void LC_ManageTables_Test_InfoUpdated(void) {
    ...
    Ut_CFE_TBL_SetReturnCode(UT_CFE_TBL_GETADDRESS_INDEX, CFE_TBL_INFO_UPDATED,
                             1);
    Ut_CFE_TBL_ContinueReturnCodeAfterCountZero(UT_CFE_TBL_GETADDRESS_INDEX);
...
void LC_ManageTables_Test_ADTGetAddressError(void) {
    ...
    Ut_CFE_TBL_SetFunctionHook(UT_CFE_TBL_GETADDRESS_INDEX,
                               &LC_CMDS_TEST_CFE_TBL_GetAddressHook);
...
void LC_UpdateTaskCDS_Test_UpdateWatchpointError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_WRT_NO_SAVE_ERR_EID, CFE_EVS_ERROR,
...
void LC_UpdateTaskCDS_Test_UpdateActionpointError(void) {
    ...
    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_ART_NO_SAVE_ERR_EID, CFE_EVS_ERROR,
...
void LC_UpdateTaskCDS_Test_UpdateAppDataError(void) {
    ...
    /* Verify results */
    UtAssert_True(Result == -1, "Result == -1");
    UtAssert_True(LC_AppData.CDSSavedOnExit == LC_CDS_SAVED,
                  "LC_AppData.CDSSavedOnExit == LC_CDS_SAVED");

    UtAssert_True(
        Ut_CFE_EVS_EventSent(
            LC_APP_NO_SAVE_START_ERR_EID, CFE_EVS_ERROR,
...
void LC_Cmds_Test_AddTestCases(void) {
    UtTest_Add(LC_AppPipe_Test_SampleAPRequest, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_SampleAPRequest");
    UtTest_Add(LC_AppPipe_Test_HousekeepingRequest, LC_Test_Setup,
               LC_Test_TearDown, "LC_AppPipe_Test_HousekeepingRequest");
    UtTest_Add(LC_AppPipe_Test_Noop, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_Noop");
    UtTest_Add(LC_AppPipe_Test_Reset, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_Reset");
    UtTest_Add(LC_AppPipe_Test_SetLCState, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_SetLCState");
    UtTest_Add(LC_AppPipe_Test_SetAPState, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_SetAPState");
    UtTest_Add(LC_AppPipe_Test_SetAPPermoff, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_SetAPPermoff");
    UtTest_Add(LC_AppPipe_Test_ResetAPStats, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_ResetAPStats");
    UtTest_Add(LC_AppPipe_Test_ResetWPStats, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_ResetWPStats");
    UtTest_Add(LC_AppPipe_Test_InvalidCommandCode, LC_Test_Setup,
               LC_Test_TearDown, "LC_AppPipe_Test_InvalidCommandCode");
    UtTest_Add(LC_AppPipe_Test_MonitorPacket, LC_Test_Setup, LC_Test_TearDown,
               "LC_AppPipe_Test_MonitorPacket");

    UtTest_Add(LC_SampleAPReq_Test_AllowSampleAllWatchStale, LC_Test_Setup,
               LC_Test_TearDown,
    ...
    UtTest_Add(
        ...
        "LC_SampleAPReq_Test_StartLessOrEqualToEndAndEndWithinArrayWatchStale");
    UtTest_Add(LC_SampleAPReq_Test_ArrayIndexOutOfRange, LC_Test_Setup,
               LC_Test_TearDown, "LC_SampleAPReq_Test_ArrayIndexOutOfRange");

    UtTest_Add(LC_HousekeepingReq_Test_WatchStale, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_WatchStale");
    UtTest_Add(LC_HousekeepingReq_Test_WatchFalse, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_WatchFalse");
    UtTest_Add(LC_HousekeepingReq_Test_WatchTrue, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_WatchTrue");
    UtTest_Add(LC_HousekeepingReq_Test_WatchError, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_WatchError");
    UtTest_Add(LC_HousekeepingReq_Test_DefaultWatchResult, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_DefaultWatchResult");
    UtTest_Add(LC_HousekeepingReq_Test_ActionNotUsedStale, LC_Test_Setup,
               LC_Test_TearDown, "LC_HousekeepingReq_Test_ActionNotUsedStale");
    UtTest_Add(LC_HousekeepingReq_Test_APStateActiveActionPass, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_HousekeepingReq_Test_APStateActiveActionPass");
    UtTest_Add(LC_HousekeepingReq_Test_APStatePassiveActionFail, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_HousekeepingReq_Test_APStatePassiveActionFail");
    UtTest_Add(LC_HousekeepingReq_Test_APStateDisabledActionError,
               LC_Test_Setup, LC_Test_TearDown,
               "LC_HousekeepingReq_Test_APStateDisabledActionError");
    UtTest_Add(LC_HousekeepingReq_Test_APStatePermOffActionError, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_HousekeepingReq_Test_APStatePermOffActionError");
    UtTest_Add(LC_HousekeepingReq_Test_DefaultCurrentStateAndActionResult,
               LC_Test_Setup, LC_Test_TearDown,
    ...
    UtTest_Add(LC_HousekeepingReq_Test_UpdateTaskCDSNotSuccess, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_HousekeepingReq_Test_UpdateTaskCDSNotSuccess");

    /* Noop fully tested in LC_AppPipe_Test_Noop */
    /* Reset fully tested in LC_AppPipe_Test_Reset */

    UtTest_Add(LC_ResetCounters_Test, LC_Test_Setup, LC_Test_TearDown,
               "LC_ResetCounters_Test");

    UtTest_Add(LC_SetLCStateCmd_Test_Active, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetLCStateCmd_Test_Active");
    UtTest_Add(LC_SetLCStateCmd_Test_Passive, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetLCStateCmd_Test_Passive");
    UtTest_Add(LC_SetLCStateCmd_Test_Disabled, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetLCStateCmd_Test_Disabled");
    UtTest_Add(LC_SetLCStateCmd_Test_Default, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetLCStateCmd_Test_Default");

    UtTest_Add(LC_SetAPStateCmd_Test_Default, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetAPStateCmd_Test_Default");
    UtTest_Add(LC_SetAPStateCmd_Test_SetAllActionPointsActive, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_SetAPStateCmd_Test_SetAllActionPointsActive");
    UtTest_Add(LC_SetAPStateCmd_Test_SetAllActionPointsPassive, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_SetAPStateCmd_Test_SetAllActionPointsPassive");
    UtTest_Add(LC_SetAPStateCmd_Test_SetAllActionPointsDisabled, LC_Test_Setup,
               LC_Test_TearDown,
    ...
    UtTest_Add(LC_SetAPStateCmd_Test_InvalidCurrentAPStateActive, LC_Test_Setup,
               LC_Test_TearDown,
    ...
    UtTest_Add(LC_SetAPStateCmd_Test_InvalidAPNumberActive, LC_Test_Setup,
               LC_Test_TearDown, "LC_SetAPStateCmd_Test_InvalidAPNumberActive");
    UtTest_Add(LC_SetAPStateCmd_Test_InvalidAPNumberPassive, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_SetAPStateCmd_Test_InvalidAPNumberPassive");
    UtTest_Add(LC_SetAPStateCmd_Test_InvalidAPNumberDisabled, LC_Test_Setup,
               LC_Test_TearDown,
    ...
    UtTest_Add(LC_SetAPPermOffCmd_Test_APNotDisabled, LC_Test_Setup,
               LC_Test_TearDown, "LC_SetAPPermOffCmd_Test_APNotDisabled");
    UtTest_Add(LC_SetAPPermOffCmd_Test_Nominal, LC_Test_Setup, LC_Test_TearDown,
               "LC_SetAPPermOffCmd_Test_Nominal");

    UtTest_Add(LC_ResetAPStatsCmd_Test_AllActionPoints, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetAPStatsCmd_Test_AllActionPoints");
    UtTest_Add(LC_ResetAPStatsCmd_Test_SingleActionPoint, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetAPStatsCmd_Test_SingleActionPoint");
    UtTest_Add(LC_ResetAPStatsCmd_Test_InvalidAPNumber, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetAPStatsCmd_Test_InvalidAPNumber");

    UtTest_Add(LC_ResetResultsAP_Test, LC_Test_Setup, LC_Test_TearDown,
               "LC_ResetResultsAP_Test");

    UtTest_Add(LC_ResetWPStatsCmd_Test_AllWatchPoints, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetWPStatsCmd_Test_AllWatchPoints");
    UtTest_Add(LC_ResetWPStatsCmd_Test_SingleWatchPoint, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetWPStatsCmd_Test_SingleWatchPoint");
    UtTest_Add(LC_ResetWPStatsCmd_Test_InvalidWPNumber, LC_Test_Setup,
               LC_Test_TearDown, "LC_ResetWPStatsCmd_Test_InvalidWPNumber");

    UtTest_Add(LC_ResetResultsWP_Test, LC_Test_Setup, LC_Test_TearDown,
               "LC_ResetResultsWP_Test");

    UtTest_Add(LC_VerifyMsgLength_Test_HKRequestLengthError, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_VerifyMsgLength_Test_HKRequestLengthError");
    UtTest_Add(LC_VerifyMsgLength_Test_APSampleLengthError, LC_Test_Setup,
               LC_Test_TearDown, "LC_VerifyMsgLength_Test_APSampleLengthError");
    UtTest_Add(LC_VerifyMsgLength_Test_GenericLengthError, LC_Test_Setup,
               LC_Test_TearDown, "LC_VerifyMsgLength_Test_GenericLengthError");
    UtTest_Add(LC_VerifyMsgLength_Test_Nominal, LC_Test_Setup, LC_Test_TearDown,
               "LC_VerifyMsgLength_Test_Nominal");

    UtTest_Add(LC_ManageTables_Test_InfoUpdated, LC_Test_Setup,
               LC_Test_TearDown, "LC_ManageTables_Test_InfoUpdated");
    UtTest_Add(LC_ManageTables_Test_WDTGetAddressError, LC_Test_Setup,
               LC_Test_TearDown, "LC_ManageTables_Test_WDTGetAddressError");
    UtTest_Add(LC_ManageTables_Test_ADTGetAddressError, LC_Test_Setup,
               LC_Test_TearDown, "LC_ManageTables_Test_ADTGetAddressError");

    UtTest_Add(LC_UpdateTaskCDS_Test_UpdateWatchpointError, LC_Test_Setup,
               LC_Test_TearDown, "LC_UpdateTaskCDS_Test_UpdateWatchpointError");
    UtTest_Add(LC_UpdateTaskCDS_Test_UpdateActionpointError, LC_Test_Setup,
               LC_Test_TearDown,
               "LC_UpdateTaskCDS_Test_UpdateActionpointError");
    UtTest_Add(LC_UpdateTaskCDS_Test_UpdateAppDataError, LC_Test_Setup,
               LC_Test_TearDown, "LC_UpdateTaskCDS_Test_UpdateAppDataError");
    UtTest_Add(LC_UpdateTaskCDS_Test_Nominal, LC_Test_Setup, LC_Test_TearDown,
               "LC_UpdateTaskCDS_Test_Nominal");
